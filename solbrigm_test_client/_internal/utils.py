...
from solbrigm_test_client.__about__ import __version__ as tecton_version
from solbrigm_test_client._internal.data_types import MetadataOptions, RequestOptions
